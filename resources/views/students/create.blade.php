<x-page-title title="Create New Students Record"></x-page-title>
@extends('master')
        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <input type="text" name="phone_number" class="form-control" id="phoneNumber"
                    placeholder="+880 123465789" required="required">
                <div class="invalid-feedback">
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="1" name="testify" id="testify">
